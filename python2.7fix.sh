...
#Download python2.7 (the latest version before deprecation is 2.7.16)
...
echo "❗️ Note: you might need to reboot the system so the currently running apps can use the new version of python."
